...
public class SelectUserActivity extends MyBaseActivity implements View.OnClickListener {
    ...
    private void init(){
        ...
        userId = SettingUtils.get(SelectUserActivity.this,"userId");
        ...
        try {
            userInfo = db.findAll(User.class);
        } catch (DbException e) {
            e.printStackTrace();
        }
        ...
        mRv.addItemDecoration(new DividerItemDecoration(SelectUserActivity.this, DividerItemDecoration.VERTICAL_LIST));
    ...
    private HttpResultCallBack cb_getUserList = new HttpResultCallBack() {
        ...
        public void onResultCallBack(Object... objs) {
            ...
            boolean isException = handleException(SelectUserActivity.this, result);

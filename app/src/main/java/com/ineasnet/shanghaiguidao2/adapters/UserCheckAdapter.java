...
public class UserCheckAdapter extends BaseAdapter{
    ...
    public UserCheckAdapter(Context context, List<User> list){
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        if (view == null){
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_usercheck,null);
            vh.list_item_tv = (TextView) view.findViewById(R.id.list_item_tv);
            vh.list_item_checkbox = (CheckBox) view.findViewById(R.id.list_item_checkbox);
            view.setTag(vh);
        }else{
